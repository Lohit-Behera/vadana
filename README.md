...
> **Stable release** — `0.2.4`. Installers and auto-update feed are published via [GitHub Releases](https://github.com/Lohit-Behera/vadana/releases) and [docs/build.md](docs/build.md). Report issues on GitHub.
